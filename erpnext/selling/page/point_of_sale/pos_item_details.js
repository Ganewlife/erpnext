erpnext.PointOfSale.ItemDetails = class {
	...
	init_child_components() {
		this.$component.html(
			...
			<div class="item-custom-part-assuré"></div>
			<div class="item-custom-part-assureur"></div>` // Ajout du conteneur pour custom_part_assureur`
		);
		...
		this.$custom_part_assuré = this.$component.find(".item-custom-part-assuré");
		this.$custom_part_assureur = this.$component.find(".item-custom-part-assureur"); // Ajout de la référence pour custom_part_assureur
	}
	...
	render_dom(item) {
		...
		let { item_name, description, image, price_list_rate, custom_part_assuré , custom_part_assureur} = item;
		// console.log("Assureur: ",item.custom_part_assureur);
		...
		// Ajouter le champ custom_part_assureur
		this.$component.append(`<div class="item-custom-part-assuré">${custom_part_assuré || ''}</div>`);
		this.$component.append(`<div class="item-custom-part-assureur">${custom_part_assureur || ''}</div>`);
		console.log("Custom fields:", {
			custom_part_assuré: this.$custom_part_assuré.html(),
			custom_part_assureur: this.$custom_part_assureur.html()
		});
	}
